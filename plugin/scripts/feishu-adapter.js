...
function createBot(config) {
  ...
  return {
    ...
    async sendCard(chatId, { title, body, color = 'blue' }) {
      const header = { title: { tag: 'plain_text', content: title }, text_size: 'x-large', template: color };
    ...
    async sendButtons(chatId, title, buttons) {
      ...
      return _sendInteractive(chatId, {
        ...
        header: { title: { tag: 'plain_text', content: headerText }, text_size: 'x-large', template: 'blue' },
        elements,
      });
    },
