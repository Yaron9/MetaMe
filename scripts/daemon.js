...
// Skill routing (keyword → /skillname prefix) lives in daemon-skill-routes.js;
// its test audits every route against the shipped skills/ directory.
const { routeSkill, isMacLocalOrchestratorIntent } = require('./daemon-skill-routes');
